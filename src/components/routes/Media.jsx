...
const mediaItems = [
  {
    ...
    thumbnail: "https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Fopensats.org%2Fstatic%2Fimages%2Fblog%2F66-opensats-2024-year-in-review.jpg&f=1&nofb=1&ipt=9fe59f9f528d5d7f8087b82b180b5c02d5a44451345e2d93b95bd4bbb3c93b4d",
    description: "OpenSats announced funding for Frostr, a threshold signing protocol implementing FROST signatures to enhance security by distributing users' cryptographic keys across multiple devices or services.",
                ...
                <CardContent className="p-5">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <div className="flex items-center gap-2 text-sm text-gray-400">
                      ...
                      <span>•</span>
                      <span>{new Date(mediaItem.date).toLocaleDateString('en-US', { month: 'short', day: 'numeric', year: 'numeric' })}</span>
                    </div>
                  </div>
